...
def test_scrape_links():
    ...
    try:
        with sync_playwright() as p:
            ...
            page.goto("https://charityvillage.com/volunteer-job-search/#results/6852df3ec1907e5971143865?job_type=Unpaid+Volunteer+Position&page_num=1&kw=")
            page.wait_for_timeout(2000)

            with open(output_file, "w") as file:
                while True:
                    volunteer_cards = page.locator("//a[@class='cl-job-link']")
    ...
    old_file = "charityvillage/charityvillage.txt"  # Replace with actual path
