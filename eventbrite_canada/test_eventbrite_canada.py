...
def test_scrape_links():
    ...
    try:
        with sync_playwright() as p:
            ...
            page.goto("https://www.eventbrite.com/d/canada/free--charity-and-causes--events/volunteering-opportunity/?page=1")
            page.wait_for_timeout(3000)

            with open(output_file, "w") as file:
                while True:
                    volunteer_cards = page.locator("//div[@class='Stack_root__1ksk7']/child::a")
    ...
    old_file = "eventbrite_canada/eventbrite_canada.txt"  # Replace with actual path
