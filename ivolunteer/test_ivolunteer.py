...
def test_scrape_links():
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page.goto("https://www.ivolunteer.ca/need/index/")
            page.wait_for_timeout(2000)

            with open(output_file, "w") as file:
                while True:
                    volunteer_cards = page.locator(".action.action-primary ")
    ...
    old_file = "ivolunteer/ivolunteer.txt"  # Replace with actual path
