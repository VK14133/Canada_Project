...
def test_scrape_links():
    ...
    try:
        with sync_playwright() as p:
            ...
            page.goto("https://www.jebenevole.ca/offre_benevolat/")
            page.wait_for_timeout(5000)

            with open(output_file, "w") as file:
                while True:
                    volunteer_cards = page.locator("//div[contains(@class, 'offre_wrapper col-md-6')]/a")
                    ...
                    for i in range(count):
                        ...
                        if link and link not in seen_links:
                            seen_links.add(link)
                            file.write(f"https://www.jebenevole.ca{link}\n")
    ...
    old_file = "jebenevole/jebenevole.txt"  # Replace with actual path
