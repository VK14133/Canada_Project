...
def test_scrape_links():
    ...
    try:
        with sync_playwright() as p:
            ...
            page.goto("https://www.toronto.ca/services-payments/water-environment/live-green-toronto/environmental-volunteer-opportunities/")
            page.wait_for_timeout(2000)

            with open(output_file, "w") as file:
                while True:
                    volunteer_cards = page.locator(".heading")
    ...
    old_file = "toronto/toronto.txt"  # Replace with actual path
