...
def test_scrape_links():
    ...
    try:
        with sync_playwright() as p:
            ...
            page.goto("https://victoria.volunteerattract.com/Listings.php?ListType=Volunteer_PositionsShowAll")
            page.wait_for_timeout(3000)

            with open(output_file, "w") as file:
                while True:
                    volunteer_cards = page.locator("//td[@class='listCell colnum_0 mode-panel']/a")
                    ...
                    for i in range(count):
                        ...
                        if link and link not in seen_links:
                            seen_links.add(link)
                            file.write(f"https://victoria.volunteerattract.com/{link}\n")

                    next_button = page.locator(".pgLnkNxt")
    ...
    old_file = "victoria/victoria.txt"  # Replace with actual path
