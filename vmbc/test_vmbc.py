...
def test_scrape_links():
    ...
    try:
        with sync_playwright() as p:
            ...
            page.goto("https://vmbc.volunteerattract.com/Listings.php?ListType=VolunteerPositionsAll&MenuItemID=1")
            page.wait_for_timeout(3000)

            with open(output_file, "w") as file:
                while True:
                    volunteer_cards = page.locator("//span[@class='customLink']//a")
                    ...
                    for i in range(count):
                        ...
                        if link and link not in seen_links:
                            seen_links.add(link)
                            file.write(f"https://vmbc.volunteerattract.com/{link}\n")
    ...
    old_file = "vmbc/vmbc.txt"  # Replace with actual path
