...
def test_scrape_links():
    ...
    try:
        with sync_playwright() as p:
            ...
            page.goto("https://www.volunteermanitoba.ca/volunteer_opportunities.php")
            page.wait_for_timeout(3000)

            with open(output_file, "w") as file:
                while True:
                    volunteer_cards = page.locator("//div[@class='panel']/a")
                    ...
                    for i in range(count):
                        ...
                        if link and link not in seen_links:
                            seen_links.add(link)
                            file.write(f"https://www.volunteermanitoba.ca/{link}\n")

                    # no need of next button
                    next_button = page.get_by_text("no need of next button")
    ...
    old_file = "volunteermanitoba/volunteermanitoba.txt"  # Replace with actual path
