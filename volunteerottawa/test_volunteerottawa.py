...
def test_scrape_links():
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page.goto("https://volunteerottawa.ca/volunteer/search-volunteer-opportunities/")
            page.wait_for_timeout(3000)

            with open(output_file, "w") as file:
                while True:
                    volunteer_cards = page.locator("//a[@class='jet-listing-dynamic-link__link']")
    ...
    old_file = "volunteerottawa/volunteerottawa.txt"  # Replace with actual path
