...
def test_scrape_links():
    ...
    try:
        with sync_playwright() as p:
            ...
            page.goto("https://volunteersuccess.com/opportunities?distance_enabled=true")
            ...
            with open(output_file, "w") as file:
                ...
                volunteer_cards = page.locator("//p[@class='opp-title-text opportunityName']/a")
                ...
                for i in range(total):
                    ...
                    if link and link not in seen_links:
                        seen_links.add(link)
                        file.write(f"https://volunteersuccess.com{link}\n")
    ...
    old_file = "volunteersuccess/volunteersuccess.txt"
